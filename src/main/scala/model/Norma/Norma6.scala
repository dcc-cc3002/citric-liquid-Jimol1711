...
class Norma6(val player: PlayerCharacter, statChosen: Int) extends Norma {
   ...
   *
   * In the case of Norma6, the player has already reached the required Norma level to win.
   *
   */
